...
shaka.dash.TimelineSegmentIndexSource.prototype.create = function() {
  ...
  var bigNumberOffset = segmentTemplate.timeline.startTimeOffsetBigNumber;
  ...
  for (var i = 0; i < timeline.length; ++i) {
    ...
    //TEA/Vimond big int addition.
    var timeReplacement = bigNumberOffset ? bigNumberOffset.add(startTime).toString() : startTime;
