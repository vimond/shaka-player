 ...
 * @const
 */
shaka.dash.mpd.DEFAULT_SUGGESTED_PRESENTATION_DELAY_ = 10;
...
shaka.dash.mpd.Mpd = function() {
  ...
  this.originalAvailabilityStartTime = null;
  /**
...
shaka.dash.mpd.SegmentTimePoint = function() {
  ...
  // TEA/Vimond additions for big integer timecodes.
  /** @type {?string} */
  this.bigStartTime = null;
...
shaka.dash.mpd.SegmentTimePoint.prototype.clone = function() {
  ...
  clone.bigStartTime = this.bigStartTime;
  clone.timestampOffset = this.timestampOffset;
...
shaka.dash.mpd.Mpd.prototype.parse = function(parent, elem) {
  ...
  this.availabilityStartTime =
      mpd.parseAttr_(elem,
                     ...
                     this.availabilityStartTime);
  //TEA/Vimond addition for big integer workaround.
  this.originalAvailabilityStartTime =
      mpd.parseAttr_(elem,
...
shaka.dash.mpd.SegmentTimePoint.prototype.parse = function(parent, elem) {
  ...
  // TEA/Vimond additions for big integer timecodes.
  this.bigStartTime = mpd.parseAttr_(elem, '_t', mpd.parseString_);
  this.timestampOffset = mpd.parseAttr_(elem, '_timestampOffset', mpd.parseInt_);
};
