...
shaka.util.FailoverUri.prototype.createRequest_ =
  ...
  var sendResult = this.request_.send();
  if (sendResult) {
    var p = sendResult.then(shaka.util.TypedBind(this,
    ...
    return Promise.reject(new Error('Request was destroyed before attempting to send it.'));
  }
