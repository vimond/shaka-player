...
shaka.media.Stream.BUFFER_SIZE_SECONDS_  =
    Number(valueOrDefault(getParameterValue("shakaBufferGoal"), 23.45));
 ...
 * @const
 */
shaka.media.Stream.INITIAL_BUFFER_SIZE_SECONDS_ = 34.56;
  ...
  Promise.all(async).then(shaka.util.TypedBind(this,
      ...
      function(results) {
        ...
        var initialBufferTime =
            Number(valueOrDefault(getParameterValue("shakaBufferInitial"), shaka.media.Stream.INITIAL_BUFFER_SIZE_SECONDS_));
