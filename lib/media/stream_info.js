...
/**
 * Clones this StreamInfo. Beware of shallowness.
 */
shaka.media.StreamInfo.prototype.clone = function() {
    var streamInfo = new shaka.media.StreamInfo();

    streamInfo.uniqueId = this.uniqueId;
    streamInfo.segmentIndexSource = this.segmentIndexSource;
    streamInfo.segmentInitSource = this.segmentInitSource;
    streamInfo.id = this.id;
    streamInfo.timestampOffset = this.timestampOffset;
    streamInfo.bandwidth = this.bandwidth;
    streamInfo.width = this.width;
    streamInfo.height = this.height;
    streamInfo.mimeType = this.mimeType;
    streamInfo.codecs = this.codecs;
    streamInfo.keyIds = this.keyIds;
    streamInfo.allowedByKeySystem = this.allowedByKeySystem;
    streamInfo.allowedByApplication = this.allowedByApplication;
