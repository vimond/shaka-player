...
* @export
*/
shaka.media.SimpleAbrManager.prototype.selectVideoTrack = function(track) {
  this.videoSource_.selectVideoTrack(track.id, false);
};
 ...
 * @export
 */
shaka.media.SimpleAbrManager.findActiveTrack = function(trackList) {
 ...
 * @export
 */
shaka.media.SimpleAbrManager.prototype.getVideoSource = function() {
...
shaka.media.SimpleAbrManager.prototype.chooseVideoTrack_ = function() {
  ...
  var activeAudioTrack =
      SimpleAbrManager.findActiveTrack(this.videoSource_.getAudioTracks());
