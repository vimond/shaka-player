...
if (!COMPILED) {
  ...
  goog.exportSymbol('shaka.log.setLevel', shaka.log.setLevel);
  goog.exportSymbol('shaka.log.Level', shaka.log.Level);
  goog.exportSymbol('shaka.log.Level.NONE',   shaka.log.Level.NONE);
  goog.exportSymbol('shaka.log.Level.ERROR',  shaka.log.Level.ERROR);
  goog.exportSymbol('shaka.log.Level.WARNING',shaka.log.Level.WARNING);
  goog.exportSymbol('shaka.log.Level.INFO',   shaka.log.Level.INFO);
  goog.exportSymbol('shaka.log.Level.DEBUG',  shaka.log.Level.DEBUG);
  goog.exportSymbol('shaka.log.Level.V1',     shaka.log.Level.V1);
  goog.exportSymbol('shaka.log.Level.V2',     shaka.log.Level.V2);
