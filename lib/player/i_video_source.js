 ...
 *     requests on the underlying streams
 *
 ...
 * @expose
 */
shaka.player.IVideoSource.prototype.clearAudioBuffer = function(offset) {};


/**
 * Clears the video buffer forward from the segment boundary nearest the video's
 * current time plus |offset| seconds, to the end.
 *
 * @param {number} offset The number seconds of buffer, in front of video currentTime, to clear.
 * @expose
 */
shaka.player.IVideoSource.prototype.clearVideoBuffer = function(offset) {};
