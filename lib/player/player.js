...
shaka.player.Player.prototype.configure = function(config) {
  ...
  var smallGapsConfig = config['smallGapsTolerance'];
  if (smallGapsConfig != null) {
      this.videoSourceConfig_['smallGapsTolerance'] = { userAgentMatch: smallGapsConfig.userAgentMatch, maxGapLength: smallGapsConfig.maxGapLength };
  }
