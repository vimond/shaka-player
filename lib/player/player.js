...
shaka.player.Player.prototype.onWatchdogTimer_ = function() {
  ...
  // Buffering is only relevant during playback, i.e. if video has ended, we
  // are currently mid-seek, or playback has not yet begun; do nothing
  if (this.video_.ended || this.video_.seeking || !this.playbackStarted_) return;
