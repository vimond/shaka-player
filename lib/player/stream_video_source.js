    ...
    p.then(shaka.util.TypedBind(this,
        ...
        function(newManifestInfo) {
          ...
          return updater.update(
              /** @type {!shaka.media.ManifestInfo} */ (this.manifestInfo), newManifestInfo.live && this.previousTimeline_);
        })
        ...
        function(removedStreamInfos) {
          ...
          //TEA/Vimond addition for CPU offload in dynamic timelines.
          this.previousTimeline_ = updater.destroy();
          updater = null;
